...
def attia_network_age(samp_freq,time,num_leads):
    ...
    conv1 = tf.keras.layers.Conv1D(filters=16,kernel_size=7,strides=1,padding='same')(input_layer)
    conv1 = tf.keras.layers.BatchNormalization()(conv1)
    conv1 = tf.keras.layers.Activation("relu")(conv1)
    conv1 = tf.keras.layers.MaxPooling1D(pool_size=2)(conv1)
    
    # Temporal analysis block 2
    conv2 = tf.keras.layers.Conv1D(filters=16,kernel_size=5,strides=1,padding='same')(conv1)
    conv2 = tf.keras.layers.BatchNormalization()(conv2)
    conv2 = tf.keras.layers.Activation("relu")(conv2)
    conv2 = tf.keras.layers.MaxPooling1D(pool_size=2)(conv2)
    
    # Temporal analysis block 3
    conv3 = tf.keras.layers.Conv1D(filters=32,kernel_size=5,strides=1,padding='same')(conv2)
    conv3 = tf.keras.layers.BatchNormalization()(conv3)
    conv3 = tf.keras.layers.Activation("relu")(conv3)
    conv3 = tf.keras.layers.MaxPooling1D(pool_size=2)(conv3)
    
    # Temporal analysis block 4
    conv4 = tf.keras.layers.Conv1D(filters=32,kernel_size=5,strides=1,padding='same')(conv3)
    ...
    conv5 = tf.keras.layers.Conv1D(filters=64,kernel_size=5,strides=1,padding='same')(conv4)
    ...
    conv6 = tf.keras.layers.Conv1D(filters=64,kernel_size=3,strides=1,padding='same')(conv5)
    ...
    conv7 = tf.keras.layers.Conv1D(filters=64,kernel_size=3,strides=1,padding='same')(conv6)
    ...
    conv8 = tf.keras.layers.Conv1D(filters=64,kernel_size=3,strides=1,padding='same')(conv7)
    ...
    spatial_block_1 = tf.keras.layers.Conv1D(filters=128,kernel_size=1,strides=1,padding='same')(conv8)
